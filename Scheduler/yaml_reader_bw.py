...
if __name__ == '__main__':
    ...
    optimal_name = ['gb_bw_25', 'gb_bw_40', 'gb_bw_55', 'gb_bw_70', 'gb_bw_85', 'gb_bw_100']
    our_name = ['sol_bw_25', 'sol_bw_40', 'sol_bw_55', 'sol_bw_70', 'sol_bw_85', 'sol_bw_100']
    videoedge_name = ['videoedge_bw_25', 'videoedge_bw_40', 'videoedge_bw_55', 'videoedge_bw_70',
                      'videoedge_bw_85', 'videoedge_bw_100']
    ourp_name = ['sol_p_bw_25', 'sol_p_bw_40', 'sol_p_bw_55', 'sol_p_bw_70', 'sol_p_bw_85', 'sol_p_bw_100']
    bw = [25, 40, 55, 70, 85, 100]
    # for i in range(len(optimal_name)):
    for i in range(len(our_name)):
        yaml_name = '/data/rch/iwqos/Scheduler/bandwidth/{}.yaml'.format(our_name[i])
        print(yaml_name)
        # yaml_name = '/data/rch/iwqos/Scheduler/num/videoedge_num_32.yaml'
        main(yaml_name, i)
        # main_optimal(yaml_name, i)

        name = 'results_{}'.format(bw[i])
        # name = 'results_{}'.format(num[i])
        cmd = 'cp -r  results ../result_bw/{}'.format(name)
        os.system(cmd)
        cmd = 'rm results/*'
        os.system(cmd)
    ...
    for i in range(len(optimal_name)):
        yaml_name = '/data/rch/iwqos/Scheduler/bandwidth/{}.yaml'.format(optimal_name[i])
        print(yaml_name)
        # yaml_name = '/data/rch/iwqos/Scheduler/num/videoedge_num_32.yaml'
        # main(yaml_name, i)
        main_optimal(yaml_name, i)

        name = 'optimal_results_{}'.format(bw[i])
        # name = 'results_{}'.format(num[i])
        cmd = 'cp -r  results ../result_bw/{}'.format(name)
        os.system(cmd)
        cmd = 'rm results/*'
    ...
    for i in range(len(videoedge_name)):
        yaml_name = '/data/rch/iwqos/Scheduler/bandwidth/{}.yaml'.format(videoedge_name[i])
        print(yaml_name)
        # yaml_name = '/data/rch/iwqos/Scheduler/num/videoedge_num_32.yaml'
        main_videoedge(yaml_name, i)

        name = 'videoedge_results_{}'.format(bw[i])
        # name = 'results_{}'.format(num[i])
        cmd = 'cp -r  results ../result_bw/{}'.format(name)
        os.system(cmd)
        cmd = 'rm results/*'
    ...
    for i in range(len(ourp_name)):
        yaml_name = '/data/rch/iwqos/Scheduler/bandwidth/{}.yaml'.format(ourp_name[i])
        print(yaml_name)
        # yaml_name = '/data/rch/iwqos/Scheduler/num/videoedge_num_32.yaml'
        main_ourp(yaml_name, i)
        name = 'ourp_results_{}'.format(bw[i])
        # name = 'results_{}'.format(num[i])
        cmd = 'cp -r  results ../result_bw/{}'.format(name)
        os.system(cmd)
        cmd = 'rm results/*'
